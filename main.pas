...
Change History
Version 7.0.0.14
Wann      Wer   Modul     Was                                        Gemeldet von
25.03.12 | WW | Main    | Scalierung für Schriftarten und Netbook  |
         |    | alle    | angepasst                                |
25.03.12 | WW | GD      | Falsche Einträge bei Tag korrigiert      | Fürth
25.03.12 | WW | Main    | Einfrieren des Imports bei               | Fürth
         |    |         | Bildschirmschoner                        |
Version 7.1.0.0
18.06.12 | WW | Main    | Sichern geht nicht                       | Fürth
21.06.12 | WW | DM      | Tabelle Version eingefügt                | Allendorf
         |    |         | Tabelle Gottesdienst erweitert           | Allendorf
21.06.12 | WW | Kartei  | Schnelleres Blättern in der Liste        | Wuppertal
Version 7.1.0.1
23.06.12 | WW | Input   | Ping beim Schließen mit Enter beseitigt  | Darmstadt
26.06.12 | WW | Main    | Sichern geht nicht                       | Saarbrücken
Version 7.1.0.2
05.07.12 | WW | Main    | Absender auf Etiketten nicht abschaltbar | Wuppertal
08.07.12 | WW | Ausgabe | Export als CSV Datei möglich             | Darmstadt
         |    |         | Es werden jetzt immer 2 Dateien erstellt |
         |    |         | Eine in UTF8 Kodierung und eine in ANSI  |
         | WW | Main/GD | Sicheres schliessen der DB vor der       | Fürth und andere
         |    |         | Datensicherung                           |
         | WW |NewDB.SQL| Tabelle Version mit aufgenommen          | Allendorf
         | WW |KarteiKarte.lrf| Schreibfehler beseitigt            | Darmstadt
Version 7.1.0.3
17.08.12 | WW | Main    | Sortierung nach Alter beim Drucken       | Allendorf
         | WW | Kartei  | Zu und Abgangsseite überarbeitet         | Fürth
         | WW | Main    | Freie Liste überarbeitet                 |
Version 7.1.0.4
28.08.12 | WW | Kartei  | Doppelklick statt Klick bei E-Mail       | Darmstadt
07.09.12 | WW | Main    | Jubiläumsliste eingefügt                 | Darmstadt
         | WW | Kartei  | Vorname bei Schnellsuche löschen         | Allendorf
Version 7.1.0.5
         | WW | Main    | CSV Import eingefügt                     | Darmstadt
Version 7.2.0.0
         | WW | Main    | Anrede nach Geschlecht setzten           | GE_Buch
24.11.12 | WW | Kartei  | Blättern mit Bild Hoch Tasten verbessert | Darmstadt
06.12.12 | WW | Kartei  | Feld Todesort eingefügt                  |
         |    |         | Felder Email2, Internet2... eingefügt    | Darmstadt
         |    | Alle    | Verhalten für Netbooks optimiert         | Olle Icke
Version 7.2.0.1
07.01.13 | WW | Main    | Datenimport sicherer                     | Saarbrücken
07.01.13 | WW | Main    | Datensicherung überarbeitet              | Saarbrücken
         |    |         | Jubiläumsliste Geburtstage ab 65         | Saarbrücken
         |    |         | Jubiläumsliste Abgänge weg               | Allendorf und Essen
         |    |         | Geburtstagsliste mit Alter               | Essen
         |    |         | Karteikarte ergänzt und neu formatiert   | Essen
Version 7.2.0.2
08.01.13 | WW | Main    | Büchersendung statt Drucksachen          | Essen
         |    |         | Karteikarte ergänzt und neu formatiert   | Essen
         |    |         | Datensicherung überarbeitet              | Saarbrücken
Version 7.2.0.3
         |    |         | Karteikarte ergänzt und neu formatiert   | Essen
         |    |         | Datensicherung überarbeitet              | Saarbrücken
Version 7.2.0.4
         |    |         | Speichern der Datenbank in einem andern  |
         |    |         | Verzeichnis / Laufwerk ermöglichen       |
Version 7.2.0.5
27.01.13 | WW | Main    | Lösche alle markierten Personen          |
         |    |         | Statistik markiert Abgänge               |
         |    |         | Sortierreihenfolge bei Umlauten          |
Version 7.2.0.6
10.02.13 | WW | Main    | CSV-Import ignoriert leere Zeilen        |
         |    |         | Hilfe bei CSV - Import überarbeitet      |
         |    |         | Datenimport sicherer                     | Spiesen
Änderungen in der Version 7.3.0.0
Scalierung bei verschiedenen Bildschirmauflösungen verbessert        Spiesen
Datenbankzugiff vereinheitlicht                                      Spiesen

Änderungen in der Version 7.3.0.1 (26.08.2013)
CSV-Import: UTF8 Dateien werden besser gelesen
Druckmenu wird nach Druck auf Einstellungseintrag automatisch wieder angezeigt
Im Druckmenu wird bei Ort zuerst nach Postleitzahl sortiert.
Report für Zweckform 3474 (70x37mm, 24 Etiketten auf einer DIN-A4 Seite) erstellt
Automatische Datensicherung

Änderungen in der Version 7.4.0.0 (16.10.2013)
Lazarus Comiler 1.0.12 verwendet
ZeosDB 7.0.5 verwendet
CSV-Import: Datumsbehandlung verbessert
Aktuelle Geburtstagsanzeige auf "Morgen" und "Übermorgen" erweitert.
Besuche in der Statistik werden gruppiert
Besuche können auf andere Personen kopiert werden
Wenn Sie Ihren Rechner anders geschützt haben, können Sie das Passwort in der Kommandozeile übergeben.

Änderungen in der Version 7.4.0.1 (18.10.2013)
Aktuelle Geburtstagsanzeige auf "Morgen" und "Übermorgen" erweitert hatte noch einen Fehler.

Änderungen in der Version 7.4.0.2 (28.12.2013)
Viele kleine Programmverbesserungen
Einseitige Karteikarte hinzugefügt (Design von einem Benutzer)
Fehlende Felder in Karteikartendruck hinzugefügt
Etiketten ZF_3475_3490_70_36mm mit Anrede hinzugefügt
In der Karteimaske optische Korrekturen und Verbesserungen eingefügt
Datensicherung erfolgt automatisch jeden Monat
Verbesserungen bei anderen Bildschirmauflösungen / Schriftgrößen

Änderungen in der Version 7.4.0.3 (04.11.2014)
Statistik: Gruppierung der Personen hatte noch ein Fehler, wen der Eintrag "Gemeinde" nicht genutzt wurde.

Änderungen in der Version 7.4.0.4 (06.11.2014)
Statistik: Abgänge aus Vorjahren werden nicht mit gezählt.

Änderungen in der Version 7.4.1.0 (12.03.2014)

Kartei: Schnellübersicht bei dem Kommunikanten zeigt aktuelles Jahr zuerst
Drucken: Einseitige Karteikarte erstellt (mit Kindern)
Jubiläumsliste: Bereich der angezeigen Geburtstage kann in der INI-Datei eingestellt werden

Interne Änderung: Lazarus 1.2.0 und ZeosLib 7.0.5 benutzt

Änderungen in der Version 7.4.1.1 (26.03.2014)

Kartei: Tabulatorreihenfolge bei den Paten korrigiert

Änderungen in der Version 7.5.1.0 (06.04.2017)
Nold / Konstanz: Bei den Kindern kann kein Taufdatum eingegeben werden.
}
          ...
          while not frmDM.dsetPersonen.EOF do
            begin
              ...
              if not frmDM.dsetPersonen.fieldByName('Abgang').asboolean
                then
                  begin
                    if (frmDM.dsetPersonen.fieldByName('KonfDatum').asstring <> '') //Nur für Erwachsene
                      then
                        begin
                          if ok
                            then
                ...
                then // zu zählende Personen
                  begin
                    if sNewYearZugang = ''
                      then
                        begin
                          if frmDM.dsetPersonen.fieldByName('KonfDatum').asstring <> ''
                            then inc(erw)
                            else
                              try
